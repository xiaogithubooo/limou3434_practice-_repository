...
public:
    ...
    {
        //ç”±äºæ¯æ¬¡å–çš„åŒºé—´éƒ½æ˜¯å–å†…éƒ¨çš„ max å’Œ min
        //å› æ­¤â€œå’Œè°â€ä¸å†…éƒ¨æ•°æ®çš„é¡ºåºæ— å…³
        //å¹¶ä¸”å…è®¸åˆ é™¤ä¸éœ€è¦çš„æ•°å­—

        //å› æ­¤æˆ‘ä»¬å…ˆå°†æ•°ç»„æ’åº
        sort(nums.begin(), nums.end());
        //1,3,2,2,5,2,3,7
        //1,2,2,2,3,3,5,7
        
        int ret = 0;//è®°å½•æœ€å¤§å€¼
...
//    int findLHS(vector<int> nums)
//    {
//        //ÓÉÓÚÃ¿´ÎÈ¡µÄÇø¼ä¶¼ÊÇÈ¡ÄÚ²¿µÄ max ºÍ min
//        //Òò´Ë¡°ºÍĞ³¡±ÓëÄÚ²¿Êı¾İµÄË³ĞòÎŞ¹Ø
//        //²¢ÇÒÔÊĞíÉ¾³ı²»ĞèÒªµÄÊı×Ö
//
//        //Òò´ËÎÒÃÇÏÈ½«Êı×éÅÅĞò
//        sort(nums.begin(), nums.end());
//        //1,3,2,2,5,2,3,7
...
//            {
//                string cache;
//                cache.insert(cache.end(), begin, cur);
//                v[*cur - '0'] = cache;
//                count++;
//                if(cur != str.end() - 1)
//                    begin = cur + 2;
...
//{
//    Solution s;
//    cout << s.sortSentence("is2 sentence4 This1 a3");
//    return 0;
//}