...
#define DEFAULT_SZ 3//默认容量3个，注意这是新增加的宏<limou>
#define INC_SZ 2//每次翻倍次数，注意这是新增加的宏<limou>
...
//3.函数声明
//3.1.1.初始化函数
void Init_Contact(Contact* pcon);//这个函数的初始化被修改了，请注意<limou>
//3.1.2.销毁函数
void Destroy_Contact(Contact* pcon);//这个函数是新加的，请注意<limou>
//3.2.增加指定联系人函数
void Add_Contact(Contact* pcon);//这个函数的初始化被修改了，请注意<limou>
//3.3.显示联系人信息
